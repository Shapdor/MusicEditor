...
public class MockMidiDevice implements Synthesizer {
   ...
   * a synthesizer might have a worst-case delay of a few milliseconds or more.</p>
   *
   ...
   * <code>isSoundbankSupported</code> method of <code>Synthesizer</code>.)</p>
   *
   ...
   * <code>getLoadedInstruments()</code>.</p>
   *
   * <p>
   ...
   * <code>Soundbank</code> is supported, you can try loading the instrument.</p>
   *
   ...
   * to reopen such a device will always result in a MidiUnavailableException.</p>
   *
   ...
   * the {@code MidiDeviceReceiver} interface.</p>
   *
   ...
   * closed explicitly by calling {@link #close}.</p>
   *
   ...
   * the {@code MidiDeviceTransmitter} interface.</p>
   *
