...
public class MusicReader {
   ...
   * @param <IMusicEditorModel> The main model interface type describing music compositions
   * @return the new model
   */
  public static <IMusicEditorModel> IMusicEditorModel parseFile(Readable readable,
                                                                CompositionBuilder
      ...
      switch (lineType) {
        ...
        case "note":
          try {
            ...
            piece.addNote(startBeat, endBeat, instrument - 1, pitch, volume);
          } catch (NoSuchElementException e) {
